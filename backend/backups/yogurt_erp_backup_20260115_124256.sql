...
\restrict CxjhefnJtJPG7zy6MLMJq0IdYqldueSbOAXpxvYvrQW3DLxcDFecNasfDVgelYw
...
CREATE TABLE public.cheques (
    ...
    CONSTRAINT cheques_status_check CHECK (((status)::text = ANY (ARRAY[('pending'::character varying)::text, ('cleared'::character varying)::text, ('bounced'::character varying)::text, ('cancelled'::character varying)::text])))
);
...
CREATE TABLE public.inventory_batches (
    ...
    CONSTRAINT inventory_batches_status_check CHECK (((status)::text = ANY (ARRAY[('available'::character varying)::text, ('allocated'::character varying)::text, ('sold'::character varying)::text, ('expired'::character varying)::text])))
);
...
CREATE TABLE public.payments (
    ...
    CONSTRAINT payments_status_check CHECK (((status)::text = ANY (ARRAY[('pending'::character varying)::text, ('completed'::character varying)::text, ('cancelled'::character varying)::text])))
);
...
CREATE TABLE public.payroll (
    ...
    CONSTRAINT worker_salary_payments_payment_status_check CHECK (((payment_status)::text = ANY (ARRAY[('pending'::character varying)::text, ('paid'::character varying)::text, ('partial'::character varying)::text])))
);
...
CREATE TABLE public.sales (
    ...
    CONSTRAINT sales_payment_status_check CHECK (((payment_status)::text = ANY (ARRAY[('pending'::character varying)::text, ('partial'::character varying)::text, ('paid'::character varying)::text]))),
    CONSTRAINT sales_sold_by_check CHECK (((sold_by)::text = ANY (ARRAY[('ADMIN'::character varying)::text, ('SALESPERSON'::character varying)::text]))),
...
CREATE TABLE public.sales_allocations (
    ...
    CONSTRAINT sales_allocations_status_check CHECK (((status)::text = ANY (ARRAY[('allocated'::character varying)::text, ('sold'::character varying)::text, ('returned'::character varying)::text])))
);
...
CREATE TABLE public.salesperson_allocations (
    ...
    CONSTRAINT salesperson_allocations_status_check CHECK (((status)::text = ANY (ARRAY[('active'::character varying)::text, ('completed'::character varying)::text, ('returned'::character varying)::text, ('cancelled'::character varying)::text])))
);
...
CREATE TABLE public.salesperson_locations (
    ...
    updated_at timestamp without time zone DEFAULT CURRENT_TIMESTAMP,
    CONSTRAINT salesperson_locations_status_check CHECK (((status)::text = ANY (ARRAY[('online'::character varying)::text, ('offline'::character varying)::text])))
);
...
CREATE TABLE public.users (
    ...
    created_at timestamp without time zone DEFAULT CURRENT_TIMESTAMP,
    updated_at timestamp without time zone DEFAULT CURRENT_TIMESTAMP,
    CONSTRAINT users_role_check CHECK (((role)::text = ANY (ARRAY[('ADMIN'::character varying)::text, ('SALESPERSON'::character varying)::text, ('ACCOUNTANT'::character varying)::text, ('PRODUCTION'::character varying)::text])))
);
...
CREATE TABLE public.worker_salary_payments (
    ...
    CONSTRAINT worker_salary_payments_payment_status_check1 CHECK (((payment_status)::text = ANY (ARRAY[('pending'::character varying)::text, ('paid'::character varying)::text, ('partial'::character varying)::text])))
);
...
957589cc-f420-47c8-8c10-595a9b98cda5	edf1a6d5-74f8-4efe-a51e-14595b6befb2	2cebdda7-be8e-41fb-8ae4-ca2227857abb	2026-01-13-001	10.00	2026-01-13	\N	available	2026-01-13 11:26:02.221459	2026-01-15 06:38:18.149309
\.
...
edf1a6d5-74f8-4efe-a51e-14595b6befb2	Set Yogurt	15585139-a24c-4e77-a056-9f8d792b35d1	piece	50.00	50.00	\N	0.00	2026-01-08 16:17:26.773062	2026-01-15 06:38:18.149309
\.
...
93b2a280-7d76-44f2-93b0-36589d6ad3c1	92edf483-ed05-4a20-9422-c4ad2b979c24	1520.00	0.00	completed	2026-01-15	\N	2026-01-15 06:40:37.527247	2026-01-15 06:40:37.527247	0.00
\.
...
c1b2772f-3ec0-4e77-9977-14c51edacc40	92edf483-ed05-4a20-9422-c4ad2b979c24	96191b15-5b8a-4ff5-8a87-e56e64980bda	19.00	80.00	2026-01-15 06:40:37.506057	f
\.
...
92edf483-ed05-4a20-9422-c4ad2b979c24	f1927a80-d3db-4135-98b4-d942e77d6d2b	e093c86e-e49f-445c-9751-f63ed64c4eb5	2026-01-15	1520.00	paid	\N	2026-01-15 06:40:37.506057	2026-01-15 06:40:37.527247	SALESPERSON
\.
...
bf014dba-c082-41b7-9db1-b67e3b9e1b6f	4ed4a859-0895-4ed1-828e-11c7ff2cf2a1	96191b15-5b8a-4ff5-8a87-e56e64980bda	e093c86e-e49f-445c-9751-f63ed64c4eb5	2026-01-08-002	181.00	2026-01-15	active	\N	5da64e83-1413-4d59-b6f9-772f09242a79	2026-01-15 06:38:18.149309	2026-01-15 06:40:37.506057
\.
...
18ca4f9e-a480-4315-a835-120e5c2a912d	e093c86e-e49f-445c-9751-f63ed64c4eb5	6.87058000	81.34839600	500.00	2026-01-15 06:40:50.185366	2026-01-08 04:40:07.388502	online	2026-01-10 04:12:28.821393
\.
...
5da64e83-1413-4d59-b6f9-772f09242a79	System Administrator	admin@yogurt.com	admin	$2a$10$tJxBUDHzWUcfsfIgIcPMFepWvvYW34oJuKL/sz.TYl.cFC/W0F/MC	ADMIN	t	2026-01-06 06:18:48.337216	2026-01-15 07:12:34.233341
e093c86e-e49f-445c-9751-f63ed64c4eb5	Sales Person 1	salesperson@yogurt.com	salesperson	$2a$10$TP.gBrwpDpvp8JfvgFAKueUkoOgFjshex6g6W/Nu2Rof7/l1DUdMm	SALESPERSON	t	2026-01-06 06:18:48.345579	2026-01-15 07:12:34.248585
\.
...
CREATE INDEX idx_payroll_month_year ON public.payroll USING btree (year, month);
...
--
-- Name: idx_payroll_worker; Type: INDEX; Schema: public; Owner: -
--
...
\unrestrict CxjhefnJtJPG7zy6MLMJq0IdYqldueSbOAXpxvYvrQW3DLxcDFecNasfDVgelYw
