...
-- This migration sets up all missing tables, columns, and functions
-- Run this ONCE on Railway to fix all production issues
-- ============================================

-- 1. Add batch column to productions table
DO $$ 
BEGIN
...
-- 4. Add is_reversed and related columns to sales table
DO $$ 
BEGIN
    IF NOT EXISTS (SELECT 1 FROM information_schema.columns 
...
-- 7. Create function to generate batch number (explicitly in public schema)
...
-- 8. Ensure Finished Goods category exists
